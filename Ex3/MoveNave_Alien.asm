...
main:
	...
	Loadn R0, #1050
	store posAlien, r0		; Zera Posicao Atual da Alien
...
Atualisa_Alien:
		...
		load r0, posAlien
		loadn r1, #' '   ; Espaco em branco para Apagar a Alien
		outchar r1, r0	 ; Apaga a Alien
		
		inc R0			 ; Recalcula a posicao
		loadn r1, #1200  ; Criterio de Parada
		cmp r0, r1
		jne Atualisa_Alien_Skip
		loadn r0, #1050
	Atualisa_Alien_Skip:
		store posAlien, r0
		
		loadn r1, #'X'   ; Char Alien
		outchar r1, r0   ; Desenha a Alien
